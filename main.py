...
class Controller: 
    ...
    def set_base_metrics(self):
        ATTACK_VECTOR = {"L": "Local >> The attacker must either have physical access to the vulnerable system (e.g. firewire attacks) or a local account (e.g. a privilege escalation attack). {0.55}", 
        ...
        ATTACK_COMPLEXITY = {"H": "High >> Specialised conditions exist, such as a race condition with a narrow window, or a requirement for social engineering methods that would be readily noticed by knowledgeable people. {0.44}", 
        ...
        PRIVILEGES_REQUIRED = {"M": "None >> Exploitation of the vulnerability requires that the attacker authenticate two or more times, even if the same credentials are used each time. {0.45}",
        ...
        USER_INTERACTION = {"N": "None {0.85}",
            "R": "Required {0.62}"}
        SCOPE = {"U": "Unchanged",
            "C": "Changed"}
        CONFIDENTIALITY = {"N": "None >> There is no impact on the confidentiality of the system {0.0}",
        ...
        INTEGRITY = {"N": "None >> There is no impact on the integrity of the system. {0.0}",
        ...
        AVAILABILITY = {"N": "None >> There is no impact of the availability of the system. {0.0}",
